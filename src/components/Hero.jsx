    ...
    <section className="relative w-full md:h-screen h-[110vh] mx-auto" id="home">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5 text-center`}>
        <div>
          ...
          <a href='/home/register' className=' bg-tertiary px-7 w-fit py-3 m-auto sm:mt-20 mt-5 rounded-xl border-none outline-none text-white text-[18px] font-medium cursor-pointer tracking-wider relative z-10'>Register Now</a>
